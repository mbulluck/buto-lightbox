...
!function(i){var t=function(t,e){return i.ajax({dataType:"jsonp",type:"get",jsonpCallback:"callback"+t+"a",url:e+"/"+t+".jsonp?callback=?"})};i.fn.butoLightbox=function(e){var p=i.extend({api_uri:"//api.buto.tv/v2/video"},e);return this.each(function(){var h=i(this),r=h.data("id"),o=(new Spinner).spin(this),a=t(r,p.api_uri);a.success(function(t){var p=t.media_title;void 0!==e&&e.hasOwnProperty("title")&&"video"===e.title&&(p=t.video_title);var a=i("<a>").prop("href","//embed.buto.tv/"+r).prop("title",p),n=i("<img>").prop("src",t.uri.poster_frame).prop("alt",p);0===h.height()||void 0===h.height()?n.prop("height",t.published_height).prop("width",t.published_width):n.prop("width",h.width()).prop("height",h.height()),a.html(n),a.colorbox({iframe:!0,innerWidth:t.published_width,innerHeight:t.published_height}),o.stop(),h.append(a)})})}}(jQuery);